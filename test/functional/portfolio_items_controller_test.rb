...
class PortfolioItemsControllerTest < ActionController::TestCase
  ...
  test "should create portfolio_item" do
    assert_difference('PortfolioItem.count') do
      post :create, portfolio_item: { description: @portfolio_item.description, github: @portfolio_item.github, link: @portfolio_item.link, title: @portfolio_item.title }
    end
  ...
  test "should update portfolio_item" do
    put :update, id: @portfolio_item, portfolio_item: { description: @portfolio_item.description, github: @portfolio_item.github, link: @portfolio_item.link, title: @portfolio_item.title }
    assert_redirected_to portfolio_item_path(assigns(:portfolio_item))
  end
